...
<body>
	<div id="header">
		<div class="clearfix">
			<div class="logo">
				<a href="index.html"><img src="images/logo.jpg" alt="LOGO" height="202" width="209"></a>
			</div>
			<ul class="navigation">
				<li class="active">
	...
	<div id="contents">
		<div class="clearfix">
			...
			<div class="frame2">
				<div class="box">
					<img src="images/newabout.jpg" alt="Img" height="300" width="900">
				</div>
			</div>
			<h2>There's Home for every Pet</h2>
			<p>
				We make it easy to find a home for every pet, before they get mistreated.
			</p>
			<h2>Be Part of Our Community</h2>
			<p>
				Please join and help us make the world a better place for animals.
				</p>
