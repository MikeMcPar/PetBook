		...
		<div class="clearfix">
			...
			<div class="main">
				...
				<ul class="practices">
					...
					<li class="frame5">
						<a href="removepet.html" class="box"><img src="images/removepet.jpg" height="198" width="265"><span>Remove Pet</span></a>
					</li>
					<li class="frame5">
						<a href="viewpets.html" class="box"><img src="images/viewpets.png" height="198" width="265"><span>View My Pets</span></a>
					</li>
                                        <li class="frame5">
